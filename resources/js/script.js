...
if( modifyMenuTable || addMenuTable){
  ...
  addMorningRecipeButton.addEventListener('click', function(){
      ...
      + '</td>'
      + '<td>'
      + '<input type="number" aria-label="Portions" min="0" name="morning['+ incrementedMorningId +'][quantity]" form="add_menu_form" class="text--center input--inset" placeholder="Portions" required>'
      + '</td>'
      + '<td class="text--center p--1">'
      ...
      if(modifyRecipeTable){
        ...
        + '</td>'
        + '<td>'
        + '<input type="number" aria-label="Portions" min="0" name="morning['+ incrementedMorningId +'][quantity]" form="update_menu_form" class="text--center input--inset" placeholder="Portions" required>'
        + '</td>'
        + '<td class="text--center p--1">'
        + '<button type="button" name="deleteRow" id="deleteMorningRow'+ incrementedMorningId +'" class="button--sm">Delete row</button>'
        + '</td>'
  ...
  addNoonRecipeButton.addEventListener('click', function(){
      ...
      + '</td>'
      + '<td>'
      + '<input type="number" aria-label="Portions" min="0" name="noon['+ incrementedNoonId +'][quantity]" form="add_menu_form" class="text--center input--inset" placeholder="Portions" required>'
      + '</td>'
      + '<td class="text--center p--1">'
      ...
      if(modifyRecipeTable){
        ...
        + '</td>'
        + '<td>'
        + '<input type="number" aria-label="Portions" min="0" name="noon['+ incrementedNoonId +'][quantity]" form="update_menu_form" class="text--center input--inset" placeholder="Portions" required>'
        + '</td>'
        + '<td class="text--center p--1">'
        + '<button type="button" name="deleteRow" id="deleteNoonRow'+ incrementedNoonId +'" class="button--sm">Delete row</button>'
        + '</td>'
  ...
  addEveningRecipeButton.addEventListener('click', function(){
      ...
      + '</td>'
      + '<td>'
      + '<input type="number" aria-label="Portions" min="0" name="evening['+ incrementedEveningId +'][quantity]" form="add_menu_form" class="text--center input--inset" placeholder="Portions" required>'
      + '</td>'
      + '<td class="text--center p--1">'
      ...
      if(modifyRecipeTable){
        ...
        + '</td>'
        + '<td>'
        + '<input type="number" aria-label="Portions" min="0" name="evening['+ incrementedEveningId +'][quantity]" form="update_menu_form" class="text--center input--inset" placeholder="Portions" required>'
        + '</td>'
        + '<td class="text--center p--1">'
        + '<button type="button" name="deleteRow" id="deleteEveningRow'+ incrementedEveningId +'" class="button--sm">Delete row</button>'
        + '</td>'
